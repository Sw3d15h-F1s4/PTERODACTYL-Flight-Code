...
float Thermistor::getTempC(){ // reads the temperature but the output value is in Celsius
  return currentTempC;
}


float Thermistor::getTempF(){ // reads the temperature but the output value is in Farenheit
  return currentTempF;
}
